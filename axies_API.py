...
#         try:
#             # 提取X轴信息
#             x_info = self._extract_x_axis_info(image_path)
            
#             # 提取Y轴信息
#             y_info = self._extract_y_axis_info(image_path)
...
#             axes_info = {
#                 'x_axis': self.x_axis_info,
#                 'y_axis': self.y_axis_info
#             }
        
#         if not axes_info['x_axis'] or not axes_info['y_axis']:
#             print("没有可用的坐标轴信息进行可视化")
#             return
